...
const OrderSummary = () => {
  ...
  return (
    <div className="w-full md:w-96 bg-gray-500/5 p-5">
        ...
        <div>
          ...
          <div className="flex flex-col items-start gap-3">
            <input
              ...
              className="flex-grow w-full outline-none p-2.5 text-gray-600 border bg-transparent"
            />
            <button className="bg-[#f85606] text-white px-9 py-2 hover:bg-orange-700">
              Apply
            </button>
          </div>
        </div>
      ...
      <button onClick={createOrder} className="w-full bg-[#f85606] text-white py-3 mt-5 hover:bg-orange-700">
        Place Order
      </button>
    </div>
  );
